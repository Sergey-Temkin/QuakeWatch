...
docker build -t sergeytemkin/quakewatch:latest .

# Authenticate with Docker Hub so you can push your image to your account
docker login

# Rebuild the image after making code changes, tagging it for Docker Hub
docker build -t sergeytemkin/quakewatch:latest .

# Upload your Docker image to your Docker Hub repository
docker push sergeytemkin/quakewatch:latest
